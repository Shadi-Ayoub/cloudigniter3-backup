...
A user seeder cannot reuse the tenant collector unchanged: Cognito, the profile table, assignments, and audit
evidence are separate participants and need an explicit recovery strategy.
