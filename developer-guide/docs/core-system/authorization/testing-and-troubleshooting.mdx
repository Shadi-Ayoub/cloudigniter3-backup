...
## Run your authorization tests

Include authorization tests in your application’s normal test pipeline. Exercise your configured catalog through
the public Core APIs, and verify that server operations enforce the resulting decisions. Cover allowed and denied
actions, Tenant and Org Unit boundaries, expired assignments, and role changes. Run these checks whenever you
change the catalog, identity adapter, or protected operations.
