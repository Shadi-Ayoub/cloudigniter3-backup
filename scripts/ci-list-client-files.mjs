// scripts/ci-list-client-files.mjs
...
if (!targetArg) {
  console.error("❌ Usage: node scripts/ci-list-client-files.mjs <folder>");
  console.error("Example: node scripts/ci-list-client-files.mjs src/layout");
  process.exit(1);
}
