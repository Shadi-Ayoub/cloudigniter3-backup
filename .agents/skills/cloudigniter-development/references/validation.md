...
Use [data-table.md](data-table.md) for the complete standard.
...
[table-keys.md](table-keys.md) for the complete convention.
...
[dynamodb-design.md](dynamodb-design.md) for the complete review.
