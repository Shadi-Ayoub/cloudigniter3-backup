...
Read [package ownership](ownership.md) first when the owning layer is unclear, and return to the [architecture overview](../overview.md) for the repository dependency direction.
