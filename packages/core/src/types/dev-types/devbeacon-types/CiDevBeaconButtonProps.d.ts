...
export interface CiDevBeaconButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "onClick"> {
    loaded: boolean;
    onClick: () => void;
...
//# sourceMappingURL=CiDevBeaconButtonProps.d.ts.map