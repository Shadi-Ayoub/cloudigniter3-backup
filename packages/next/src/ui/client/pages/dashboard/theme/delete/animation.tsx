...
export const ANIMATE_VAR_NAMES = [
  "--animate-gradiant-shift",
  "--animate-flicker",
  "--animate-fade-in",
] as const;
            ...
            <div className="absolute inset-0 grid place-items-center">
              <span className="relative inline-flex h-12 w-12 items-center justify-center rounded-full bg-[--color-primary] text-white">
                <span
                  ...
                  style={{
                    animation:
                      "animate-ci-ping 1.8s cubic-bezier(0,0,0.2,1) infinite",
          ...
          <div className="relative h-28">
            <div className="absolute inset-0 grid place-items-center">
              <span
                ...
                style={{
                  animation: "animate-ci-pulse 1.4s ease-in-out infinite",
                }}
              >
                <span className="relative z-10 text-sm font-semibold">CI</span>
              </span>
