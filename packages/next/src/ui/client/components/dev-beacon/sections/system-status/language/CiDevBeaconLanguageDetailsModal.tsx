...
import { CircleX, FileJson2, FileSearch, Loader2 } from "lucide-react";
  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        <div
          aria-hidden="true"
          className="fixed inset-0 z-3100 bg-black/45 backdrop-blur-sm"
        />

        <DialogPrimitive.Content
          aria-labelledby="ci-dev-beacon-language-details-title"
          aria-describedby="ci-dev-beacon-language-details-description"
          className={cn(
            "bg-background fixed top-1/2 left-1/2 z-3101",
            "flex h-[min(82vh,820px)] w-[min(1240px,calc(100vw-2rem))]",
            "max-w-[1240px] -translate-x-1/2 -translate-y-1/2 flex-col",
            "gap-0 overflow-hidden rounded-lg border p-0 shadow-2xl",
          )}
        >
          <CiAccessibleDialogTitle>
            <span className="sr-only">Language details</span>
          </CiAccessibleDialogTitle>

          <CiAccessibleDialogDescription>
            <span className="sr-only">
              Displays resolved language files and their loaded messages.
            </span>
          </CiAccessibleDialogDescription>
          <header className="border-b px-6 py-5">
            <h2
              id="ci-dev-beacon-language-details-title"
            ...
            <p
              id="ci-dev-beacon-language-details-description"
