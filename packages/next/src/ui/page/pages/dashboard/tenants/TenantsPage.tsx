...
import { DataTable } from '@cloudigniter/next/ui/components';
import { getLangDir } from '@cloudigniter/next/utility';
import type { CiTenant, CiTenantHtmlTableRow } from '@cloudigniter/next/types';

// import { call, consolePrint, getEnvMode, notify } from '@CI/utility';
import { usePageLoader } from '@CI/store';
// import type { CiRequest, CiSeedTenantItem, CiSeedTenantsResult, CiTenantsPageProps } from '@CI/types';
import type { CiTenantsPageProps } from '@CI/types';
    ...
    return (
      <NextIntlClientProvider locale={locale} messages={messages}>
        <div className='w-full px-6'>
          ...
          <button onClick={() => void loadTenants()} className='bg-amber-600 text-gray-800'>
            Refresh
          </button>
