...
import type { BeaconTabValue, CiEnvMode } from '@CI/types';
    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay
          ...
          style={{ top: viewportTopOffset, bottom: viewportBottomOffset, zIndex: 3000 }}
        />
        ...
        >
          ...
          <header className='bg-background/95 supports-[backdrop-filter]:bg-background/70 sticky top-0 z-[1] flex items-center justify-between border-b px-4 py-3 backdrop-blur'>
            ...
            <div className='flex items-center gap-2'>
              ...
              {headerActions}
              <Dialog.Close className='rounded-md border px-2 py-1 text-xs' aria-label='Close'>
                Close
              </Dialog.Close>
            </div>
          </header>
