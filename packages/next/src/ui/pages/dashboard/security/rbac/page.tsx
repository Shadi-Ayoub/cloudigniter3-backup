...
//             Manage system roles, their permissions, and the underlying RBAC
//             policy.
//           </p>
//         </div>
//       </div>
...
//           {!editingRole && (
//             <p className="text-muted-foreground text-sm">
//               Select a role from the list or create a new one to manage its
//               permissions.
//             </p>
//           )}
...
//           <DialogHeader>
//             <DialogTitle>
//               {editingRole?.roleId ? "Edit role" : "Create role"}
//             </DialogTitle>
//           </DialogHeader>
//           {editingRole && (
//             <RoleEditor
...
//     const next = exists
//       ? role.permissions.filter((s) => s !== scope)
...
//             value={role.roleId}
//             onChange={(e) =>
//               onChange({ ...role, roleId: e.target.value.trim() })
//             }
//             placeholder="admin, teacher, counselor..."
//             disabled={!!role.roleId} // prevent changing ID on edit
//           />
//           <p className="text-muted-foreground text-xs">
//             Used as a stable key and to derive the Cognito group name.
//           </p>
//         </div>
//         <div className="space-y-1.5">
//           <label className="text-sm font-medium">
...
//                         <Checkbox
//                           checked={checked}
//                           onCheckedChange={() => toggleScope(p.scope)}
//                         />
...
//         <p className="text-muted-foreground text-sm">
//           Configure canonical permissions (scopes) here. Roles will reference
//           these scopes.
//         </p>
//       </CardContent>
//     </Card>
