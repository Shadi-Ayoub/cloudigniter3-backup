...
export type CoreBackendResources = {
  auth: typeof auth;
  data: typeof data;

  getCognitoUserHandler: typeof getCognitoUserHandler;
  createCognitoUserHandler: typeof createCognitoUserHandler;

  // getLambdaParametersHandler: typeof getLambdaParametersHandler;

  // getSettingsHandler: typeof getSettingsHandler;
  // setSettingsHandler: typeof setSettingsHandler;

  // createTenantHandler: typeof createTenantHandler;
  // deleteTenantHandler: typeof deleteTenantHandler;
  // getTenantHandler: typeof getTenantHandler;
  // listTenantsHandler: typeof listTenantsHandler;
  // updateTenantHandler: typeof updateTenantHandler;

  // createUserHandler: typeof createUserHandler;
  // seedTenantsHandler: typeof seedTenantsHandler;
};

export const coreResources: CoreBackendResources = {
  auth,
  data,
