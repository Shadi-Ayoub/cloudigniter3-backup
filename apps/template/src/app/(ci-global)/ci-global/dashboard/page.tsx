...
/**
 * Temporary Global route placeholder.
 *
 * Remove this once concrete Global-scoped pages are implemented.
 */
export default async function CiGlobalDashboardPage() {
  const context = await appBootstrap();

  return (
    <CiPage
      name="global-dashboard-homepage"
