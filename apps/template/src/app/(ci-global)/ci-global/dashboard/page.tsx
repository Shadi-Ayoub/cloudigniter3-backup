...
type CiTenantPlaceholderPageProps = {
  params: Promise<{
    feature?: string[];
  }>;
};
 ...
 */
export default async function CiTenantPlaceholderPage({
  params,
}: CiTenantPlaceholderPageProps) {
          ...
          <section className="grid gap-4 lg:grid-cols-[1.5fr_1fr]">
            <div className="rounded-xl border bg-card p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Use this area to introduce the primary actions, reports, and
                tools available in your application.
              </p>
